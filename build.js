        ...
        <div class="container" style="max-width: 900px; margin: 0 auto; padding: 0 1.5rem;">
            ...
            <article class="single-article-card" style="background: #ffffff; border-radius: 20px; padding: 2.5rem; box-shadow: 0 10px 30px rgba(0,0,0,0.06); border: 1px solid #e2e8f0;">
                ...
                <div class="single-article-body" style="color: #334155; font-size: 1.05rem; line-height: 1.8;">
                    ...
                    <p>
                        <strong>Dojo Samurai JKA Villa Alemana</strong> es una organización deportiva y escuela marcial dedicada a la enseñanza técnica del Karate-Do Shotokan tradicional. La enseñanza del dojo está a cargo de <strong>Andrés Castro Fernández</strong>, siguiendo la línea de formación en Karate Shotokan JKA que tiene como maestro y referente técnico a <strong>Sensei Raúl Puchi Zarecht (6to Dan JKA)</strong>.
                    </p>
                    <p>
