document.addEventListener('DOMContentLoaded', () => {
    ...
    const createNewsCardHTML = (article, index = 0) => {
        const isFeatured = article.featured === true || index === 0;

        if (isFeatured) {
            return `
                <article class="news-card news-hero-card" data-id="${article.id}" style="cursor: pointer; grid-column: 1 / -1;">
                    ...
                    <div class="news-hero-grid">
                        <div class="news-hero-img-wrapper">
                            ...
                            <span class="news-category-badge badge-red">📜 ${article.category}</span>
                        </div>
